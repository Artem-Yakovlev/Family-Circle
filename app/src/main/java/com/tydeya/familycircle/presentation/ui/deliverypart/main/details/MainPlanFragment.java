package com.tydeya.familycircle.presentation.ui.deliverypart.main.details;
...
import com.tydeya.familycircle.presentation.ui.deliverypart.main.abstraction.MainPlanView;
import com.tydeya.familycircle.presentation.ui.deliverypart.main.details.recyclerview.MainPlanItem;
import com.tydeya.familycircle.presentation.ui.deliverypart.main.details.recyclerview.MainPlanItemType;
import com.tydeya.familycircle.presentation.ui.deliverypart.main.details.recyclerview.MainPlanRecyclerViewAdapter;
import com.tydeya.familycircle.presentation.ui.deliverypart.main.details.recyclerview.OnClickMainPlanItemListener;
    ...
    public void onMainPlanItemClick(MainPlanItemType itemType) {
        switch (itemType) {
            case FOOD:
                ...
                break;
            case EVENTS:
                navController.navigate(R.id.eventRibbonFragment);
                break;
            case PLANNING:
